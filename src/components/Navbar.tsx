...
const Navbar = () => {
  ...
  const navItems = [
    { name: 'Home', id: 'home', action: scrollToTop, icon: Heart },
    { name: 'Menu', id: 'menu', action: () => scrollToSection('menu'), icon: ChefHat },
    { name: 'Gallery', id: 'gallery', action: () => scrollToSection('gallery'), icon: Star },
    { name: 'About', id: 'about', action: () => scrollToSection('about'), icon: MapPin },
    { name: 'Contact', id: 'contact', action: () => scrollToSection('contact'), icon: Phone }
  ];
